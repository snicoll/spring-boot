...
class Saml2RelyingPartyRegistrationConfiguration {
	...
	private RelyingPartyRegistration asRegistration(String id, Registration properties) {
		...
		builder.assertionConsumerServiceLocation(properties.getAssertionconsumerservice().getLocation());
		builder.assertionConsumerServiceBinding(properties.getAssertionconsumerservice().getBinding());
