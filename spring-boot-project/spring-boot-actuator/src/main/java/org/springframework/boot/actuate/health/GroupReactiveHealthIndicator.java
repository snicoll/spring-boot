...
public class GroupReactiveHealthIndicator implements AggregatedReactiveHealthIndicator {
	 ...
	 */
	public GroupReactiveHealthIndicator(HealthAggregator aggregator,
			ReactiveHealthIndicatorRegistry registry, Set<String> indicatorNames) {
	...
	public Mono<Health> health() {
		ReactiveAggregatedHealth aggregatedHealth = new ReactiveAggregatedHealth(
				this.registry);
