...
public class ConditionalOnEnabledEndpointTests {
	...
	static class TestFilter implements EndpointFilter<OperableEndpointInfo<Operation>> {

		@Override
		public boolean match(OperableEndpointInfo<Operation> info,
				EndpointDiscoverer<OperableEndpointInfo<Operation>> discoverer) {
			return true;
		}
