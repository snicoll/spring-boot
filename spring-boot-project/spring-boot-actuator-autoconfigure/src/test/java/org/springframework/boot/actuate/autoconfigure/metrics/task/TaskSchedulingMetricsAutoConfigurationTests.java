...
/**
 * Tests for {@link TaskSchedulingMetricsAutoConfiguration}.
 *
 * @author Stephane Nicoll
 */
class TaskSchedulingMetricsAutoConfigurationTests {

	private final ApplicationContextRunner contextRunner = new ApplicationContextRunner().with(MetricsRun.simple())
			.withUserConfiguration(SchedulingTestConfiguration.class)
			.withConfiguration(AutoConfigurations.of(TaskSchedulingMetricsAutoConfiguration.class));
