...
public final class DataSourceBuilder<T extends DataSource> {
	...
	private final DataSourceSettingsResolver dataSourceSettingsResolver;
	...
	private DataSourceBuilder(ClassLoader classLoader) {
		this.dataSourceSettingsResolver = new DataSourceSettingsResolver(classLoader);
	}
	...
	private static class DataSourceSettingsResolver {
		...
		public DataSourceSettings getPreferredDataSourceSettings() {
			return this.preferredDataSourceSettings;
		}

		public DataSourceSettings resolve(DataSource dataSource) {
			for (DataSourceSettings dataSourceSetting : this.allDataSourceSettings) {
				if (dataSourceSetting.type.isInstance(dataSource)) {
