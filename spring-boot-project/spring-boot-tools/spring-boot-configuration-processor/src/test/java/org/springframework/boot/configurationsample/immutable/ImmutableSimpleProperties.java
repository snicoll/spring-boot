...
import org.springframework.boot.configurationsample.ConfigurationProperty;
...
public class ImmutableSimpleProperties {
	...
	public ImmutableSimpleProperties(
			@ConfigurationProperty(defaultValue = "boot") String theName, boolean flag,
