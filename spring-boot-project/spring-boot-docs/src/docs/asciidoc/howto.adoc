...
Job parameters can be specified either as application arguments or using the configprop:spring.batch.job.parameters[] property.
If a parameter with the same name exists in both, the application argument takes precedence.
