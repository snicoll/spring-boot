...
public class Layers {
	...
	/**
	 * The location of the layers configuration file. If no file is provided, the
	 * {@code default} configuration is used with four layers: {@code application},
	 * {@code resources}, {@code snapshot-dependencies} and {@code dependencies}.
