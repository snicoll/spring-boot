 ...
 * exception for map types as both the keys and values of the app can have hints. In
 * such a case, the hint should be suffixed by ".key" or ".values" respectively. Creating
 * a hint for a map using its property name has no effect.
 *
