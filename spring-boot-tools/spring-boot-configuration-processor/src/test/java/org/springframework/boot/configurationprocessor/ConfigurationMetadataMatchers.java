...
public class ConfigurationMetadataMatchers {
	...
	public static class ContainsHintMatcher extends BaseMatcher<ConfigurationMetadata> {
		...
		private final List<HintValueMatcher> values;

		public ContainsHintMatcher(String name) {
			this(name, new ArrayList<HintValueMatcher>());
		}

		public ContainsHintMatcher(String name, List<HintValueMatcher> values) {
			this.name = name;
			this.values = values;
		}
		...
		public boolean matches(Object item) {
			...
			for (HintValueMatcher value : this.values) {
		...
		public ContainsHintMatcher withValue(Object value, String description) {
			List<HintValueMatcher> values = new ArrayList<HintValueMatcher>(this.values);
			values.add(new HintValueMatcher(value, description));
	...
	public static class HintValueMatcher extends BaseMatcher<ItemHint> {
		private final Object value;
		private final String description;

		public HintValueMatcher(Object value, String description) {
			this.value = value;
			this.description = description;
		}
		...
		public boolean matches(Object item) {
			...
			ItemHint.ValueHint valueHint = getValueHint(hint);
			if (valueHint == null) {
				return false;
			}
			if (this.value != null
		...
		@Override
		public void describeTo(Description description) {
			description.appendText("value hint ");
			if (this.value != null) {
