...
/**
 * Map a {@link ConfigMetadataRepository} to and from a stream.
 *
 * @author Stephane Nicoll
 * @since 1.2.0
 */
public interface ConfigMetadataRepositoryMapper {

	/**
	 * Write the specified {@link ConfigMetadataRepository}.
	 */
	public void writeRepository(ConfigMetadataRepository repo, OutputStream out) throws IOException;

	/**
	 * Read a {@link ConfigMetadataRepository} from the specified {@link InputStream}.
	 */
