...
import org.springframework.boot.actuate.health.ReactiveHealthIndicatorFactory;
...
public class HealthWebEndpointConfiguration {
	...
	static class ReactiveWebHealthConfiguration {
		...
		ReactiveWebHealthConfiguration(ObjectProvider<HealthAggregator> healthAggregator,
			...
			this.reactiveHealthIndicator = new ReactiveHealthIndicatorFactory().createReactiveHealthIndicator(
