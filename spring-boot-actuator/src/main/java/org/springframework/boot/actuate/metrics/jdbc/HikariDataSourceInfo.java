...
/**
 * A {@link DataSourceInfo} implementation for the hikari
 * data source.
 *
 * @author Stephane Nicoll
 * @since 1.2.0
 */
public class HikariDataSourceInfo extends AbstractDataSourceInfo<HikariDataSource> {


	private final HikariPoolProvider hikariPoolProvider;

	public HikariDataSourceInfo(HikariDataSource dataSource) {
		super(dataSource);
