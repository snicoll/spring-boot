 ...
 */
public class EndpointWebFluxAdapter extends AbstractEndpointMvcAdapter<Endpoint<?>> implements WebFluxEndpoint {

	/**
	 * Create a new {@link EndpointWebFluxAdapter}.
	 * @param delegate the underlying {@link Endpoint} to adapt.
	 */
	public EndpointWebFluxAdapter(Endpoint<?> delegate) {
		super(delegate);
	}
