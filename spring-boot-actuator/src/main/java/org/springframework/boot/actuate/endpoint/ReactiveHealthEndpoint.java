...
public class ReactiveHealthEndpoint extends AbstractEndpoint<Mono<Health>> {
	...
	/**
	 * Create a new {@link ReactiveHealthEndpoint} instance.
	 * @param healthAggregator the health aggregator
	 * @param healthIndicators the health indicators
	 */
	public ReactiveHealthEndpoint(HealthAggregator healthAggregator,
			Map<String, ReactiveHealthIndicator> healthIndicators) {
		super("health", false);
		Assert.notNull(healthAggregator, "HealthAggregator must not be null");
		Assert.notNull(healthIndicators, "HealthIndicators must not be null");
		ReactiveCompositeHealthIndicator healthIndicator =
				new ReactiveCompositeHealthIndicator(healthAggregator);
		for (Map.Entry<String, ReactiveHealthIndicator> entry : healthIndicators.entrySet()) {
