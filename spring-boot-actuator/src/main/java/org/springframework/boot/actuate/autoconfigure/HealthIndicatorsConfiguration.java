...
/**
 * Configuration for available {@link HealthIndicator}.
 *
 * @author Stephane Nicoll
 */
@Configuration
class HealthIndicatorsConfiguration {
	...
	static class CassandraHealthIndicatorConfiguration extends
	...
	static class CouchbaseHealthIndicatorConfiguration extends
	...
	static class DataSourcesHealthIndicatorConfiguration extends
	...
	static class LdapHealthIndicatorConfiguration extends
		...
		LdapHealthIndicatorConfiguration(Map<String, LdapOperations> ldapOperations) {
	...
	static class MongoHealthIndicatorConfiguration extends
	...
	static class Neo4jHealthIndicatorConfiguration extends
			CompositeHealthIndicatorConfiguration<Neo4jHealthIndicator, SessionFactory> {

		private final Map<String, SessionFactory> sessionFactories;

		Neo4jHealthIndicatorConfiguration(Map<String, SessionFactory> sessionFactories) {
	...
	static class RabbitHealthIndicatorConfiguration extends
		...
		RabbitHealthIndicatorConfiguration(Map<String, RabbitTemplate> rabbitTemplates) {
	...
	static class SolrHealthIndicatorConfiguration extends
			CompositeHealthIndicatorConfiguration<SolrHealthIndicator, SolrClient> {

		private final Map<String, SolrClient> solrClients;

		SolrHealthIndicatorConfiguration(Map<String, SolrClient> solrClients) {
	...
	static class DiskSpaceHealthIndicatorConfiguration {
	...
	static class MailHealthIndicatorConfiguration extends
	...
	static class JmsHealthIndicatorConfiguration extends
