...
/**
 * {@link Plugin} for projects that <em>only</em >define manual metadata. When applied,
 * the plugin registers a {@link CheckManualSpringConfigurationMetadata} task and
 * configures the {@code check} task to depend upon it.
 *
 * @author Andy Wilkinson
 * @author Stephane Nicoll
 */
public class ManualConfigurationPropertiesPlugin implements Plugin<Project> {
