...
public class RabbitRetryTemplateSettings {
	...
	private final RabbitRetryPolicySettings retryPolicySettings;

	private final LinkedList<RetryListener> retryListeners;

	RabbitRetryTemplateSettings(RabbitRetryPolicySettings retryPolicySettings) {
		this.retryPolicySettings = retryPolicySettings;
		this.retryListeners = new LinkedList<>();
	}

	/**
	 * Return the {@link RabbitRetryPolicySettings} to use to customize the retry policy.
	 * @return the retry policy settings
	 */
	public RabbitRetryPolicySettings getRetryPolicySettings() {
