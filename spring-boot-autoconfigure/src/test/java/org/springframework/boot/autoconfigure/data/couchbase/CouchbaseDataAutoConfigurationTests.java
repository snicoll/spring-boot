...
public class CouchbaseDataAutoConfigurationTests {
	...
	public void changeConsistency() {
		...
		CouchbaseDataAutoConfiguration.SpringBootCouchbaseDataConfiguration configuration = this.context
				.getBean(CouchbaseDataAutoConfiguration.SpringBootCouchbaseDataConfiguration.class);
