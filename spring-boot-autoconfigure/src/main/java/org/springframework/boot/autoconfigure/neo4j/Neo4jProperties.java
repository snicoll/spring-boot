...
public class Neo4jProperties {
	...
	private static final String EMBEDDED_DRIVER = "org.neo4j.ogm.drivers.embedded.driver.EmbeddedDriver";

	private static final String HTTP_DRIVER = "org.neo4j.ogm.drivers.http.driver.HttpDriver";

	private static final String DEFAULT_HTTP_URI = "http://localhost:7474";
	...
	public Configuration createConfiguration() {
		...
		if (this.uri == null) {
			if (getEmbedded().isEnabled()
					&& ClassUtils.isPresent(EMBEDDED_DRIVER, null)) {
