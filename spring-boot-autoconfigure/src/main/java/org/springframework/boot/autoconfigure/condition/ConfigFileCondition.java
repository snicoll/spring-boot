...
/**
 * {@link SpringBootCondition} used to check if a configuration file can be found
 * using a configurable property and optional default location(s).
 *
 * @author Stephane Nicoll
 * @author Phillip Webb
 * @since 1.3.0
 */
public abstract class ConfigFileCondition extends SpringBootCondition {
	 ...
	 */
	protected ConfigFileCondition(String name, String prefix, String propertyName,
