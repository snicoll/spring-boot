...
@EnableConfigurationProperties(JCacheCacheProperties.class)
class JCacheCacheConfiguration {
	...
	@Autowired
	private JCacheCacheProperties jCacheCacheProperties;
	...
	public JCacheCacheManager cacheManager() {
		CacheManager cacheManager = createCacheManager(this.jCacheCacheProperties.getProvider());
	...
	private javax.cache.configuration.Configuration<?, ?> getCacheConfiguration() {
