...
import org.springframework.boot.autoconfigure.hazelcast.HazelcastConfigFileCondition;
 ...
 * @since 1.3.0
 * @see HazelcastConfigFileCondition
 */
@Configuration
...
class HazelcastCacheConfiguration {
	...
	/**
	 * {@link HazelcastConfigFileCondition} that checks if the
	 * {@code spring.cache.hazelcast.config} configuration key is defined.
	 */
	static class ConfigAvailableCondition extends HazelcastConfigFileCondition {
