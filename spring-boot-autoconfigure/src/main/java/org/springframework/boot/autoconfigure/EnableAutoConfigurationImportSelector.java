...
class EnableAutoConfigurationImportSelector implements DeferredImportSelector,
	...
	private List<String> getExcludeAutoConfigurationsProperty() {
		RelaxedPropertyResolver resolver = new RelaxedPropertyResolver(this.environment, "spring.application.");
		String[] value = resolver.getProperty("exclude-auto-configurations", String[].class);
		if (value != null) {
