...
import org.springframework.boot.autoconfigure.condition.ConfigFileCondition;
 ...
 * if configurable property referring to the file to use has been set.
 *
 * @author Stephane Nicoll
 * @since 1.3.0
 */
public abstract class HazelcastConfigFileCondition extends ConfigFileCondition {

	static final String CONFIG_SYSTEM_PROPERTY = "hazelcast.config";

	protected HazelcastConfigFileCondition(String prefix, String propertyName) {
