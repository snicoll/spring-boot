...
/**
 * Bind {@link ConfigurationProperties} annotated object from the {@code Environment}.
 *
...
public class ConfigurationPropertiesBinder {
	...
	public ConfigurationPropertiesBinder(Validator validator,
	...
	public void bind(Object bean, String beanName) {
	...
	void bind(Object bean, String beanName, ConfigurationProperties annotation) {
	...
	private Validator determineValidator(Object bean) {
		boolean supportsBean = (this.validator != null && this.validator.supports(bean.getClass()));
