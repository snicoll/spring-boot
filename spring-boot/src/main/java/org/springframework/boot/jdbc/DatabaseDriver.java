...
public enum DatabaseDriver {
	...
	FIREBIRD("Firebird", "org.firebirdsql.jdbc.FBDriver",
		...
		@Override
		protected boolean matchName(String product) {
			return super.matchName(product)
	...
	DatabaseDriver(String name, String driverClassName, String xaDataSourceClassName, String validationQuery) {
		this.name = name;
	...
	protected boolean matchName(String product) {
		return this.name != null && this.name.equalsIgnoreCase(product);
	}
	 ...
	 * @return the database driver or {@link #UNKNOWN} if not found
	 */
	public static DatabaseDriver fromName(String name) {
